...
`PUT /api/v1/recipes_ny/sushi` - обновление информации о рецепте новогодних суши

`DELETE /api/v1/recipes_ny/fruit_salad` - удалить рецепт новогоднего фруктового салата